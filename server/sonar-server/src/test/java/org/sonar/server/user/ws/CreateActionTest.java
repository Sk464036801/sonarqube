...
public class CreateActionTest {
  ...
  public void setUp() throws Exception {
    ...
    service = new UserService(
      (UserIndexer) new UserIndexer(dbClient, esTester.client()).setEnabled(true),
      new UserIndex(esTester.client()),
      new UserUpdater(mock(NewUserNotifier.class), settings, userGroupDao, dbClient, system2));
